        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="GET" action="{{ route('treatments.index') }}" class="mb-6 bg-gray-50 p-4 rounded-lg shadow-sm">
                        <div class="md:flex gap-4 space-y-3 md:space-y-0">
                            <div class="flex-1">
                                <div class="relative">
                                    ...
                                    <input type="text" name="search" value="{{ request('search') }}" 
                                        ...
                                        placeholder="Search by patient name or treating doctor">
                                </div>
                            </div>
                            <div class="w-full md:w-64">
                                <select name="type" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                                    ...
                                    <option value="anti_vegf" {{ request('type') == 'anti_vegf' ? 'selected' : '' }}>Anti-VEGF</option>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">
                                                <a href="{{ route('patients.show', $treatment->patient) }}" class="hover:text-blue-600">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                {{ $treatment->treatingDoctor ? $treatment->treatingDoctor->name : 'Not assigned' }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            {{ $treatment->follow_up_date ? $treatment->follow_up_date->format('Y-m-d') : 'Not scheduled' }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-3">
                                                ...
                                                <form action="{{ route('treatments.destroy', $treatment) }}" method="POST" class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
